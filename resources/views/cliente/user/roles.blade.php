...
@section('content_header')
    <h1>Dashboard | Gestión de roles</h1>
@stop

@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="card col-lg-10 col-ms-12 col-md-8">
                    ...
                    <table id="list-roles" class="table table-striped shadow-lg" width:"100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$data->name}}</td>
                                <td>
                                    <form action="{{ route('roles.destroy', $data->id) }}" method="POST" class="formEliminar">
                                        <a href="{{ route('roles.edit', $data->id) }}" class="btn btn-outline-secondary">EDIT</a>
                                        @csrf
                                        @method('DELETE')
    ...
    icon="fas fa-bolt" size='lg' disable-animations>
        <form action="{{ route('roles.store') }}" method="POST">
            ...
            <div class="form-group">
                <label for="" class="label-control">Nombre del rol</label>
